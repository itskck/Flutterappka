...
import 'package:skladappka/wczytajZestaw/Edytuj.dart';
import 'package:skladappka/Firebase/PobierzBazeDanych/PobierzKod.dart';
import 'package:connectivity_plus/connectivity_plus.dart';

class rateComponents extends StatefulWidget {

  static Builds builds;

  @override
  _rateComponents createState() => _rateComponents();
}
class _rateComponents extends State<rateComponents>{
  int nextPage=0;
